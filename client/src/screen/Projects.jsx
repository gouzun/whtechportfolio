...
const Projects = () => {
  ...
  const [resList, setResList] = useState([
    ...
    },
    {
      ...
      pDesc: 'An AI art generator web app is a software application that uses machine learning algorithms to generate unique and original art pieces. The app typically utilizes a neural network that has been trained on a large dataset of artworks, which allows it to learn and mimic various styles and techniques. The user can input specific parameters such as the desired art style, colors, and patterns, and the app will generate a custom art piece based on those inputs.The primary goal of an AI art generator web app is to provide users with a new and innovative way to create art that is both unique and personalized',
